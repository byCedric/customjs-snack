// Copied from systemjs/src/common.js to rewrite node-related code
...
export var hasDocument = typeof document !== 'undefined' && typeof document.createElement === 'function';
...
if (!process.env.SYSTEM_BROWSER && !baseUrl && typeof process !== 'undefined') {
  // NOTE(cedric): only use `process.cwd` when not in React Native
  // var cwd = process.cwd();
