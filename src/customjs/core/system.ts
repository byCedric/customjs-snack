...
import { global, hasSymbol } from '../utils/runtime';
...
declare global { // TODO: make not-global
  namespace SystemJS {
    ...
    export type SystemModuleUrl = string;

    /** The module metadata object */
    export interface SystemModuleMeta {
      url: SystemModuleUrl;
      resolve(id: SystemModuleUrl, parent?: SystemModuleUrl): Promise<SystemModuleUrl>;
    }

    export type SystemModule = any; // todo
    ...
    export class System {
       ...
       */
      import(id: SystemModuleUrl, parentId?: SystemModuleUrl, meta?: SystemModuleMeta): Promise<SystemModule>;
       ...
       */
      createContext(parentId: SystemModuleUrl): SystemModuleMeta;

      /**
       * Declaration function for defining modules of the `System.register` polyfill module format.
       * @see https://github.com/systemjs/systemjs/blob/6.14.2/docs/api.md#systemregisterdeps-declare
       */
      register(dependencies: SystemModuleUrl[], definition: SystemModuleDefinition, metas: SystemModuleMeta[]): void;

      /**
       * Return the last anonymous `System.register` registration.
       * This can be useful when evaluating a module definition.
       */
      getRegister(): undefined | [SystemModuleUrl[], SystemModuleDefinition, SystemModuleMeta[]];

      register(name: string, dependencies: SystemModuleUrl[], definition: SystemModuleDefinition, metas: SystemModuleMeta[]): void;
      getRegister(name: string): undefined | [SystemModuleUrl[], SystemModuleDefinition, SystemModuleMeta[]];
...
var systemJSPrototype = (SystemJS as unknown as typeof global.SystemJS.System).prototype;
...
export const System: SystemJS.System = new SystemJS();

declare namespace actualGlobal {
