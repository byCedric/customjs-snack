// Copied from systemjs/src/extras/module-types.js

import { resolveUrl } from '../utils/common';
import { System } from '../system-rn';
  ...
  .then(function (res) {
    ...
    if (wasmContentType.test(contentType))
      ...
      .then(function (module) {
        if (!System.wasmModules)
          System.wasmModules = Object.create(null);
        System.wasmModules[url] = module;
