// Copied from systemjs/src/features/import-maps.js

import { baseUrl, resolveAndComposeImportMap, hasDocument, resolveUrl } from '../utils/common'; // Override for `process.cwd` fallback to `/`
import { System, systemJSPrototype } from '../system-rn';
